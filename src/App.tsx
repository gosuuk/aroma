                ...
                A: {
                  ...
                  children: {
                    A: {
                      ...
                      result: {
                        name: '퍼펙트 쉐이핑',
                        description: '퍼펙트 쉐이핑은 케어나 운동 전후에 사용하기 적합한 에센셜 오일로, 신진대사를 촉진하고 지방 연소를 돕는 성분이 포함되어 있습니다.\n기분을 상쾌하게 하고 활력을 증진시켜 줍니다.'
                      }
                    },
                    B: {
                ...
                <>
                  ...
                  <div className="result-description-box">
                    <p>
                      {isPerfectShaping && (
                        <>
                          퍼펙트 쉐이핑은 케어나 운동 전후에 사용하기 적합한 에센셜 오일로, 신진대사를 촉진하고 지방 연소를 돕는 성분이 포함되어 있습니다.
                          <br />
                          기분을 상쾌하게 하고 활력을 증진시켜 줍니다.
                        </>
                      )}
                      {isBreatheBreeze && (
                        brandConfig.logoText.includes('HUMAN')
                          ? '브리쓰 브리즈는 호흡을 원활하게 하고 에너지를 높여주는 향으로 가득찬 에센셜 오일입니다. 신선한 향이 주는 상쾌함이 운동 중 집중력을 향상시키고 개운함을 줍니다.'
                          : '브리쓰 브리즈는 호흡을 원활하게 하고 에너지를 높여주는 향으로 가득찬 에센셜 오일입니다. 신선한 향이 주는 상쾌함이 케어 중 집중력을 향상시키고 개운함을 줍니다.'
                      )}
